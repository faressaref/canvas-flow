...
// Keep this build step runtime-only. Do not rewrite the main application
// functions here because fragile string replacements can break the landing page.
...
const injected = `<script id="canvasflow-image-persistence-fix">(function(){
  ...
  console.log("CanvasFlow: image persistence helper installed");
})();</script>`;
...
console.log("CanvasFlow: restored stable image persistence build step.");
